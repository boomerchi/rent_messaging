...
describe Talk::Api::Landlord::Messenger do
  subject { messenger }

  let(:clazz)     { Talk::Api::Landlord::Messenger }
  ...
  describe 'API' do
    describe 'about property' do
      ...
      it 'should return property group conversator' do
        expect(conversator).to be_a Talk::Api::Landlord::PropertyGroupConversator
    ...
    describe 'to receiver' do 
      ...
      it 'should encapsulate the messenger' do
        expect(conversator.messenger).to be_a Talk::Api::Landlord::Messenger
        expect(conversator.messenger).to eq(messenger)
      end
