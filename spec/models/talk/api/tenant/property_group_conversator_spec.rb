...
describe Talk::Api::Tenant::PropertyGroupConversator do
  subject { property_group_conversator }

  let(:clazz)     { Talk::Api::Tenant::PropertyGroupConversator}
  ...
  let(:messenger) { Talk::Api::Tenant::Messenger.new sender, message }  
